...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUsername()).thenReturn("arturbielecki");
    }
    ...
    public void shouldCreateCard() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/cards?key=test&token=test&name=Test%20task&" +
                "desc=Test%20Description&pos=top&idList=test_id");
